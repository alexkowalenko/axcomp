...
\begin{enumerate}
    ...
    \item \STRING\ -- character array type. Equivalent in implementation to \ARRAY\ of \CHAR, but with length unspecified.
\end{enumerate}
...
\begin{tabular}{lllp{7cm}}
    ...
    \SIZE(T) & T or v & \INTEGER & size of type T or variable v \\ % Compiletime
    \hline
\end{tabular}
\vspace{5mm}
...
\begin{itemize}
    \item \PROCEDURE s can not have nested procedures.
