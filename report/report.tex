...
\item \BOOLEAN\ constants are \TRUE\ and \FALSE.
...
\begin{itemize}
    \item \lstinline"-d" \lstinline"--defs" just produce the LLVM IR assembly output (no object code). Otherwise both are produced.
    \item \lstinline"-l" \lstinline"--ll" generate only the \lstinline".def" file.
